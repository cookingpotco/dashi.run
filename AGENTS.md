...
plan; screenshot the live canvas instead.
...
`scripts/review_followup.ts`; v1 rejects `branchName`. GitHub Actions pins
are the current major of each action; check releases when you touch a
workflow.
