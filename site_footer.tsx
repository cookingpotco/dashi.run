...
export function SiteFooter() {
  return (
    <footer className="flex w-full flex-col items-center gap-4 p-4 lg:flex-row lg:justify-center lg:gap-2">
      <div className="flex h-20 items-center gap-2 lg:h-8">
        <img
      ...
      <div className="flex w-full items-start justify-between lg:w-auto lg:items-center">
        <p className="w-44 text-body-smallest lg:w-auto">
          dashi is free and open-source under the MIT license.
        </p>
